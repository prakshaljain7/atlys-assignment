...
function RegisterPopup({ on_login_click, onClose }) {
  ...
  return (
    <div className="register-container flex flex-col items-center justify-center animate__animated animate__zoomIn">
      <div className="w-full flex justify-end" onClick={onClose}>
        <img src={close} alt="close" />
      </div>
      <h3 className="text-dark-gray mt-[-10px]">SIGN UP</h3>
      <p className="text-white text-[18px]">Create an account to continue</p>
      <div className="w-[415px] mt-10">
        <p className="text-light-gray text-semi-bold">Enter your Email</p>
        <input
          value={email}
      ...
      <div className="flex w-full mt-2 cursor-pointer" onClick={on_login_click}>
